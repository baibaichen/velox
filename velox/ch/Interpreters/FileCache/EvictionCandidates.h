...
class EvictionInfo : public folly::F14FastMap<QueueID, QueueEvictionInfoPtr>
{
public:
    EvictionInfo() = default;
    EvictionInfo(const EvictionInfo &) = delete;
    EvictionInfo & operator=(const EvictionInfo &) = delete;
...
private:
    ...
    folly::F14FastSet<CacheUsagePtr> kept_alive_cache_usage;
};

class EvictionCandidates
{
public:
    EvictionCandidates(const EvictionCandidates &) = delete;
    EvictionCandidates & operator=(const EvictionCandidates &) = delete;
...
private:
    folly::F14FastMap<FileCacheKey, KeyCandidates, FileCacheKeyHash> candidates;
